...
`,J5=()=>f.jsxs(V5,{children:[f.jsx(X5,{src:"https://img.freepik.com/free-vector/oops-404-error-with-broken-robot-concept-illustration_114360-5529.jpg?w=2000",alt:"error-img"}),f.jsx(Z5,{children:"Page not found"}),f.jsx(K5,{children:"The page you are requesting does not exist."}),f.jsx($t,{to:"#/edutech",children:f.jsx($5,{children:"Go to HomePage"})})]}),F5=({children:l})=>{const[i,o]=_.useState(null);return _.useEffect(()=>{(async()=>{try{const d=await(await fetch("https://a2pyramid.com/auth/verify-token",{method:"GET",credentials:"include"})).json();o(d.valid)}catch{o(!1)}})()},[]),i===null?f.jsx("p",{children:"Checking authentication..."}):i?l:(window.location.href="https://portal.a2pyramid.com",null)},zs=S.button`
  padding: 12px 24px;
...
`,P5=S.div`
  ...
  gap: 10px;
  flex-wrap: wrap;
`,W5=({children:l})=>{const o=Pn().pathname,u=o==="/"||o.startsWith("/edutech")||o==="/ai-smart-login";return f.jsxs(f.Fragment,{children:[!u&&f.jsxs(f.Fragment,{children:[f.jsx(rb,{}),f.jsxs("main",{style:{padding:"20px"},children:[f.jsx("h1",{children:"Welcome to the AI Smart Class Dashboard 🚀"}),f.jsxs(P5,{children:[f.jsx("a",{href:"#/ai-smart-class",style:{textDecoration:"none"},children:f.jsx(zs,{children:"Home"})}),f.jsx("a",{href:"#/about-ai-smart-class",style:{textDecoration:"none"},children:f.jsx(zs,{children:"About"})}),f.jsx("a",{href:"#/contact-ai-smart-class",style:{textDecoration:"none"},children:f.jsx(zs,{children:"Contact"})})]})]})]}),l,f.jsx(x3,{})]})};function I5(){return f.jsx(Sv,{children:f.jsx(W5,{children:f.jsxs(Pb,{children:[f.jsx(Qe,{path:"/",element:f.jsx(k3,{})}),f.jsx(Qe,{path:"/edutech/about",element:f.jsx(aS,{})}),f.jsx(Qe,{path:"/edutech/contact",element:f.jsx(hS,{})}),f.jsx(Qe,{path:"/edutech",element:f.jsxs(f.Fragment,{children:[f.jsx(To,{}),f.jsx(BS,{}),f.jsx(YS,{}),f.jsx(FS,{}),f.jsx(i5,{}),f.jsx(y5,{}),f.jsx(O5,{}),f.jsx(H5,{}),f.jsx(Q5,{})]})}),f.jsx(Qe,{path:"/edutech/*",element:f.jsxs(f.Fragment,{children:[f.jsx(To,{}),f.jsx(J5,{})]})}),f.jsx(Qe,{path:"/ai-smart-class",element:f.jsx(d3,{})}),f.jsx(Qe,{path:"/about-ai-smart-class",element:f.jsx(E3,{})}),f.jsx(Qe,{path:"/contact-ai-smart-class",element:f.jsx(_3,{})}),f.jsx(Qe,{path:"/doubt-solver",element:f.jsx(F5,{children:f.jsx(g4,{})})}),f.jsx(Qe,{path:"/exam-paper-generator",element:f.jsx(j4,{})}),f.jsx(Qe,{path:"/smart-quiz-generator",element:f.jsx(_4,{})}),f.jsx(Qe,{path:"/performance-metrics",element:f.jsx(M4,{})}),f.jsx(Qe,{path:"/gamified-classroom",element:f.jsx(N4,{})}),f.jsx(Qe,{path:"/mental-health-support",element:f.jsx(U4,{})}),f.jsx(Qe,{path:"/skill-progress-tracking",element:f.jsx(B4,{})}),f.jsx(Qe,{path:"/attendance-report",element:f.jsx(H4,{})}),f.jsx(Qe,{path:"/revision-planner",element:f.jsx(X4,{})}),f.jsx(Qe,{path:"/ai-smart-login",element:f.jsx(wS,{})}),f.jsx(Qe,{path:"*",element:f.jsx(m3,{})})]})})})}tx.createRoot(document.getElementById("root")).render(f.jsx(_.StrictMode,{children:f.jsx(I5,{})}));
