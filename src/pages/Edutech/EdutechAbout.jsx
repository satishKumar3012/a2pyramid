...
const EdutechAbout = () => {
  ...
  return (
    ...
    <div className="form-buttons">
      <ButtonStyled href="https://forms.gle/P7sDPc4fsMcr2DJV7" target='_blank'>Google Form</ButtonStyled>
      <ButtonStyled href="https://forms.gle/P7sDPc4fsMcr2DJV7" target='_blank'>Join Now</ButtonStyled>
