...
const AiMlCourse = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="relative bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-white py-20 lg:py-32 mt-16 lg:mt-20">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl">
                <Clock size={32} className="mx-auto mb-4 text-purple-200" />
                <h3 className="text-lg font-semibold mb-2">Duration</h3>
                <p className="text-purple-100">{courseData.duration}</p>
              </div>
              <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl">
                <Users size={32} className="mx-auto mb-4 text-purple-200" />
                <h3 className="text-lg font-semibold mb-2">Eligibility</h3>
                <p className="text-purple-100">{courseData.eligibility}</p>
              </div>
              <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl">
                <Award size={32} className="mx-auto mb-4 text-purple-200" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.button
                className="px-8 py-4 border-2 border-white text-white hover:bg-white hover:text-purple-900 font-semibold rounded-lg transition-colors duration-300 flex items-center justify-center gap-2"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <Download size={20} />
